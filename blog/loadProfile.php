		...
		if(isset($_GET['userID'])){
			...
			if($res->num_rows>0){
				...
				if(isset($_SESSION['logged']) && $_SESSION['logged']!=$user){
					...
					if($r==1)
						echo "<span style = 'margin:25px;'><a href = 'network.php?src=0&userID=".$user."'><img src = 'unfollow.jpg' height 25px width = 25px alt = 'remove from network'/></a></span></h1>";
					else
					echo "<span style = 'margin:25px;'><a href = 'network.php?src=1&userID=".$user."'><img src = 'follow.jpg' height 25px width = 25px alt = 'add to network'/></a></span></h1>";
				}
