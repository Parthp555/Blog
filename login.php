 ...
 <body>
  ...
  <br>
 	...
 	<form action="login.php?count=1" method="post" class="login" onsubmit="return check()">
 		<label>USERNAME:</label><input type="text" name="userID" id ="userID"><p><br>
 		<label>PASSWORD:</label><input type="password" name="pswd" id="pswd"><p><br>
 		<button type = "submit">LOGIN</button><p><br>
 		NEW USER?&nbsp;&nbsp;&nbsp;&nbsp;<a href="register.php?reg=0" style="text-align: center;">Sign Up</a>
 	</form>
